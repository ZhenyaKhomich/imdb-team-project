...
export const routes: Routes = [
  {
    path: AppRoutesEnum.MAIN, redirectTo: AppRoutesEnum.MAIN, pathMatch: 'full',
  },
  {
    path: AppRoutesEnum.MAIN, component: LayoutComponent,
    children: [
      {
      ...
      {
        path: '**',
        loadComponent: () => import('./components/pages/error-404/error-404.component').then(m => m.Error404Component),
      },
    ]
  },
];
